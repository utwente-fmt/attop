...
public enum EdgeKind implements Enumerator {
	/**
	 * The '<em><b>DEPENCENCY</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #DEPENCENCY_VALUE
	 * @generated
	 * @ordered
	 */
	DEPENCENCY(1, "DEPENCENCY", "DEPENCENCY"),
	...
	/**
	 * The '<em><b>DEPENCENCY</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>DEPENCENCY</b></em>' literal object isn't clear,
	 ...
	 * @ordered
	 */
	public static final int DEPENCENCY_VALUE = 1;
	...
	public static EdgeKind get(int value) {
		switch (value) {
			case DEPENCENCY_VALUE: return DEPENCENCY;
