...
public class UATMM_structurePackageImpl extends EPackageImpl implements UATMM_structurePackage {
	 ...
	 * @generated
	 */
	public EReference getConnector_Gate() {
	 ...
	 * @generated
	 */
	public EAttribute getRDEP_Factor() {
	...
	public void createPackageContents() {
		...
		createEReference(connectorEClass, CONNECTOR__GATE);
		...
		createEAttribute(rdepEClass, RDEP__FACTOR);
	...
	public void initializePackageContents() {
		...
		rdepEClass.getESuperTypes().add(this.getConnector());
		...
		initEReference(getNode_Connector(), this.getConnector(), this.getConnector_Gate(), "connector", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		getNode_Children().getEKeys().add(this.getNode_Id());
		...
		initEAttribute(getNode_Nature(), this.getNature(), "nature", "Attack", 1, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNode_Role(), this.getRoleType(), "role", "Contributing", 1, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEdge_EdgeKind(), this.getEdgeKind(), "edgeKind", "DEPENDENCY", 1, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(connectorEClass, Connector.class, "Connector", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConnector_Gate(), this.getNode(), this.getNode_Connector(), "gate", null, 1, 1, Connector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(rdepEClass, nl.utwente.ewi.fmt.UATMM.UATMM_structure.RDEP.class, "RDEP", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRDEP_Factor(), ecorePackage.getEDouble(), "factor", "1.0", 1, 1, nl.utwente.ewi.fmt.UATMM.UATMM_structure.RDEP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(edgeKindEEnum, EdgeKind.DEPENDENCY);
