...
public class NodeImpl extends MinimalEObjectImpl.Container implements Node {
	...
	public void setConnector(Connector newConnector) {
		if (newConnector != connector) {
			...
			if (connector != null)
				msgs = ((InternalEObject)connector).eInverseRemove(this, UATMM_structurePackage.CONNECTOR__GATE, Connector.class, msgs);
			if (newConnector != null)
				msgs = ((InternalEObject)newConnector).eInverseAdd(this, UATMM_structurePackage.CONNECTOR__GATE, Connector.class, msgs);
