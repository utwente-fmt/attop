...
public interface UATMM_structurePackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Gate</b></em>' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CONNECTOR__GATE = 0;
	 ...
	 * @ordered
	 */
	int PAND__GATE = CONNECTOR__GATE;
	 ...
	 * @ordered
	 */
	int TAND__GATE = CONNECTOR__GATE;
	 ...
	 * @ordered
	 */
	int KOF_N__GATE = CONNECTOR__GATE;
	 ...
	 * @ordered
	 */
	int WEIGHTED__GATE = CONNECTOR__GATE;
	 ...
	 * @ordered
	 */
	int SAND__GATE = CONNECTOR__GATE;
	 ...
	 * @ordered
	 */
	int FDEP__GATE = CONNECTOR__GATE;
	 ...
	 * @ordered
	 */
	int SPARE__GATE = CONNECTOR__GATE;
	...
	/**
	 * The meta object id for the '{@link nl.utwente.ewi.fmt.UATMM.UATMM_structure.impl.RDEPImpl <em>RDEP</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_structure.impl.RDEPImpl
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_structure.impl.UATMM_structurePackageImpl#getRDEP()
	 * @generated
	 */
	int RDEP = 16;
	 ...
	 * @ordered
	 */
	int RDEP__GATE = CONNECTOR__GATE;
	 ...
	 * @ordered
	 */
	int RDEP__FACTOR = CONNECTOR_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RDEP_FEATURE_COUNT = CONNECTOR_FEATURE_COUNT + 1;

	/**
	 * The number of operations of the '<em>RDEP</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RDEP_OPERATION_COUNT = CONNECTOR_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the container reference '{@link nl.utwente.ewi.fmt.UATMM.UATMM_structure.Connector#getGate <em>Gate</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Gate</em>'.
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_structure.Connector#getGate()
	 * @see #getConnector()
	 * @generated
	 */
	EReference getConnector_Gate();
	...
	/**
	 * Returns the meta object for class '{@link nl.utwente.ewi.fmt.UATMM.UATMM_structure.RDEP <em>RDEP</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link nl.utwente.ewi.fmt.UATMM.UATMM_structure.RDEP#getFactor <em>Factor</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Factor</em>'.
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_structure.RDEP#getFactor()
	 * @see #getRDEP()
	 * @generated
	 */
	EAttribute getRDEP_Factor();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Gate</b></em>' container reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CONNECTOR__GATE = eINSTANCE.getConnector_Gate();
		...
		/**
		 * The meta object literal for the '{@link nl.utwente.ewi.fmt.UATMM.UATMM_structure.impl.RDEPImpl <em>RDEP</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see nl.utwente.ewi.fmt.UATMM.UATMM_structure.impl.RDEPImpl
		 * @see nl.utwente.ewi.fmt.UATMM.UATMM_structure.impl.UATMM_structurePackageImpl#getRDEP()
		 ...
		 * @generated
		 */
		EAttribute RDEP__FACTOR = eINSTANCE.getRDEP_Factor();
