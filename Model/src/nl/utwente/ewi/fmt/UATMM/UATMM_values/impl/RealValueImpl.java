 ...
 * </p>
 * <ul>
 *   <li>{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.RealValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RealValueImpl extends ValueImpl implements RealValue {
	...
	protected EClass eStaticClass() {
		return UATMM_valuesPackage.Literals.REAL_VALUE;
	}
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UATMM_valuesPackage.REAL_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UATMM_valuesPackage.REAL_VALUE__VALUE:
				return getValue();
		}
