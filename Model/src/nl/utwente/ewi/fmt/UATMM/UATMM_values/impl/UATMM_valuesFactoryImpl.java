...
public class UATMM_valuesFactoryImpl extends EFactoryImpl implements UATMM_valuesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case UATMM_valuesPackage.REAL_SEQUENCE_TYPE: return createRealSequenceType();
			case UATMM_valuesPackage.REAL_SEQUENCE_VALUE: return createRealSequenceValue();
			default:
	 ...
	 * @generated
	 */
	public RealSequenceType createRealSequenceType() {
		RealSequenceTypeImpl realSequenceType = new RealSequenceTypeImpl();
		return realSequenceType;
	}
	 ...
	 * @generated
	 */
	public RealSequenceValue createRealSequenceValue() {
		RealSequenceValueImpl realSequenceValue = new RealSequenceValueImpl();
		return realSequenceValue;
	}
