...
public interface UATMM_valuesPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.RealSequenceTypeImpl <em>Real Sequence Type</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.RealSequenceTypeImpl
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.UATMM_valuesPackageImpl#getRealSequenceType()
	 * @generated
	 */
	int REAL_SEQUENCE_TYPE = 12;

	/**
	 * The number of structural features of the '<em>Real Sequence Type</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int REAL_SEQUENCE_TYPE_FEATURE_COUNT = TYPE_FEATURE_COUNT + 0;

	/**
	 * The number of operations of the '<em>Real Sequence Type</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int REAL_SEQUENCE_TYPE_OPERATION_COUNT = TYPE_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.RealSequenceValueImpl <em>Real Sequence Value</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.RealSequenceValueImpl
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.UATMM_valuesPackageImpl#getRealSequenceValue()
	 * @generated
	 */
	int REAL_SEQUENCE_VALUE = 13;
	 ...
	 * @ordered
	 */
	int REAL_SEQUENCE_VALUE__SEQUENCE = VALUE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int REAL_SEQUENCE_VALUE_FEATURE_COUNT = VALUE_FEATURE_COUNT + 1;

	/**
	 * The number of operations of the '<em>Real Sequence Value</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int REAL_SEQUENCE_VALUE_OPERATION_COUNT = VALUE_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.RealSequenceType <em>Real Sequence Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Real Sequence Type</em>'.
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.RealSequenceType
	 * @generated
	 */
	EClass getRealSequenceType();

	/**
	 * Returns the meta object for class '{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.RealSequenceValue <em>Real Sequence Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Real Sequence Value</em>'.
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.RealSequenceValue
	 * @generated
	 */
	EClass getRealSequenceValue();

	/**
	 * Returns the meta object for the attribute list '{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.RealSequenceValue#getSequence <em>Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Sequence</em>'.
	 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.RealSequenceValue#getSequence()
	 * @see #getRealSequenceValue()
	 * @generated
	 */
	EAttribute getRealSequenceValue_Sequence();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.RealSequenceTypeImpl <em>Real Sequence Type</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.RealSequenceTypeImpl
		 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.UATMM_valuesPackageImpl#getRealSequenceType()
		 * @generated
		 */
		EClass REAL_SEQUENCE_TYPE = eINSTANCE.getRealSequenceType();

		/**
		 * The meta object literal for the '{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.RealSequenceValueImpl <em>Real Sequence Value</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.RealSequenceValueImpl
		 * @see nl.utwente.ewi.fmt.UATMM.UATMM_values.impl.UATMM_valuesPackageImpl#getRealSequenceValue()
		 ...
		 * @generated
		 */
		EAttribute REAL_SEQUENCE_VALUE__SEQUENCE = eINSTANCE.getRealSequenceValue_Sequence();
