...
public class UATMM_valuesAdapterFactory extends AdapterFactoryImpl {
	...
	protected UATMM_valuesSwitch<Adapter> modelSwitch =
		new UATMM_valuesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRealSequenceType(RealSequenceType object) {
				return createRealSequenceTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.RealSequenceType <em>Real Sequence Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRealSequenceTypeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link nl.utwente.ewi.fmt.UATMM.UATMM_values.RealSequenceValue <em>Real Sequence Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
